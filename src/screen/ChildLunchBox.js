      ...
      return (
        ...
        >
          ...
          <Modal
            ...
            transparent={true}
          >
            <TouchableWithoutFeedback onPress={() => modalPopUp()}>
              <View
                style={{ flex: 1, backgroundColor: "#E8D9DB", opacity: 0.9 }}
              >
                <View
                  style={{
                  ...
                  <View style={{ flex: 1 / 4, flexDirection: "row" }}>
                    <FlatList
                      ...
                      renderItem={({ item, index }) => {
                        return (
                          <TouchableOpacity
                            onPress={() => selectRating(item.id, index)}
                            style={{
                              width: screenWidth / 4,
